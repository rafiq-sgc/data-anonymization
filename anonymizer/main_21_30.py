...
from only_csv_to_parquet import OnlyCsvToParquet
...
def main(filenames):
    ...
    file_dir = '/media/zaman/Data Storage/anonymization/data_anonymization_new/data_big/11_12' # running all for this directory, 7 big file are remaining
