...
def main(filenames):
    ...
    file_dir = '/media/zaman/Data Storage/anonymization/data_anonymization_new/main_csv_file_as_zip/J1_Data_21_04_2025' # running all for this directory, 7 big file are remaining
