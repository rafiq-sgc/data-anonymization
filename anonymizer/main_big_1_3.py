...
from readers.csv import read_csv_without_next, read_csv, split_large_csv_to_multiple
        ...
        if data:
            ...
            if anonymize:
                ...
                if is_anonymized:
                    ...
                    dest_dir = Path('/media/zaman/Data Storage/anonymization/data_anonymization_new/csv_to_parquet_40/parquet_stud_hours')
                    csv_to_parquet.csv_to_parquet_big(out_file, dest_dir, dest_dir)
            else:
                csv_to_parquet = CsvToParquetBig()
                # out_file = Path(out_dir) / file
