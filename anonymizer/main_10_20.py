...
from readers.csv import read_csv, split_large_csv_to_multiple
...
def main(filenames):
    ...
    file_dir = '/media/zaman/Data Storage/anonymization/data_anonymization_new/j1_Data_11_20' # running all for this directory, 7 big file are remaining
    out_dir = Path('/media/zaman/Data Storage/anonymization/data_anonymization_new/anonymized_csv_10_20')
    # check_dir = Path('/home/zaman/Downloads/anonymization/seu/anonymized_1')
    check_dir = Path('/media/zaman/Data Storage/anonymization/data_anonymization_new/anonymized_csv_10_20')
