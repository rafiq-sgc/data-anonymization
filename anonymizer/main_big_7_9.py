...
def main(filenames):
    ...
    file_dir = '/media/zaman/Data Storage/anonymization/data_anonymization_new/data_big/tarns_hist/11_14' # running all for this directory, 7 big file are remaining
